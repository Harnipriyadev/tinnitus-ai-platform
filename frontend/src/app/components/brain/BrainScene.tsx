...
export default function BrainScene() {
  ...
  useFrame((state, delta) => {
    ...
    if (ringOneRef.current) {
      ...
      ringOneRef.current.rotation.y += delta * 0.05;
    }

    // Rotate the violet diagnostic ring
    if (ringTwoRef.current) {
      ringTwoRef.current.rotation.z -= delta * 0.08;
      ringTwoRef.current.rotation.x += delta * 0.04;
    }
  });
  ...
  return (
    <>
      ...
      >
        <torusGeometry args={[1.78, 0.008, 12, 160]} />
